...
angular.module('characters').controller('CharactersController', ['$scope', '$stateParams', '$location', 'Authentication', 'Socket', 'Characters',
	function($scope, $stateParams, $location, Authentication, Socket, Characters) {
